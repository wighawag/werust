...
**The `windows-renderer` leg is GREEN against this code.** Run **[30588844677](https://github.com/wighawag/werust/actions/runs/30588844677)** (`workflow_dispatch`, ref `ci/windows-win32-window-and-chrome`, commit `d7f8d97`, 2026-07-30, every step succeeded). It measured on **Microsoft Windows Server 2025, 10.0.26100**, runner image `windows-2025-vs2026`, **WebView2 Runtime 150.0.4078.65** — the same runtime build the origin probe and the engine's own smoke measured on. The window smoke's verbatim output: [`window-smoke-2026-07-30.txt`](window-smoke-2026-07-30.txt).
