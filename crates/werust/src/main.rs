...
mod tests {
    use super::{
        ...
        network_trust_css_class, network_trust_label, parse_args, resolve_output,
        should_open_web_inspector, status_line, tail_plan, trust_indicator,
        trust_indicator_css_class, trust_indicator_detail, usage, Command, TailPlan, DEFAULT_URL,
    };
    use gtk4::prelude::*;
